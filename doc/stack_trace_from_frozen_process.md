...
3. Fetch the debug info file from github for your arcitecture (e.g. `Gulden-3.0.0-x86_64-linux-gnu-debug.tar.gz` for 64 bit linux debug info) extract and place in a folder on your harddrive
