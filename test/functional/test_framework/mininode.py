...
"""Gulden P2P network half-a-node.
...
MAGIC_BYTES = {
    "mainnet":  b"\xf7\xfe\xfc\xe0",  # mainnet
    ###fixme:
    "testnet3": b"\x3c\x7a\x79\x43",  # testnet3
    "regtestlegacy":  b"\xf7\xfe\xfc\xff",  # regtestlegacy
}
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtestlegacy"):
        ...
        logger.debug('Connecting to Gulden Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Gulden node.
