...
class FullBlockTest(GuldenTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure Gulden-daemon isn't accepting b26
        ...
        # Extend the b28 chain to make sure Gulden-daemon isn't accepting b28
        ...
        # Gulden-daemon doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the Gulden code has custom code which does so);
