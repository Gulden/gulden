...
# TestP2PConn: A peer we use to send messages to Gulden-daemon, and store responses.
...
class CompactBlocksTest(GuldenTestFramework):
    ...
    # This test actually causes Gulden-daemon to (reasonably!) disconnect us, so do this last.
    ...
    # Gulden-daemon's choice of nonce.
    ...
    # Test that Gulden-daemon requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for Gulden-daemon to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # Gulden-daemon will not send blocktxn responses for blocks whose height is
